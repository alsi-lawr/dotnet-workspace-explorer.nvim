...
---Validates the user-supplied partial configuration before it is merged.
...
---Validates the complete merged configuration used at runtime.
---@param options DweConfig
